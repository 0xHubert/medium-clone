    ...
    const {
     ...
     return(
        <main>
            ...
            {submitted ? (
                <div className="flex flex-col mx-auto p-8 my-10 bg-yellow-500 
                text-white max-w-2xl">
                    <h3 className="text-3xl font-bold">Thank you for submitting your comment</h3>
                    <p>Once it has been approved it will appear below!</p>  
                </div>
            ): (
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-10 mt-10 max-w-2xl mb-10 mx-auto">
                ...
                <label className="block mb-5" >
                    <span className="text-gray-700">Comment</span>
                        ...
                        className="shadow border rounded py-2 px-4 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring" 
                        rows={8} 
                        />
                </label>
                <input 
